...
const STRINGS = {
  en: {
    ...
    trust_what: "This page comes from a website. Whoever can change what that website sends can read the password you type here, and you would have no way of telling. Nothing about the encryption prevents that: it is the price of opening a vault in a browser.",
  ...
  zh: {
    ...
    trust_what: "本页面来自一个网站。任何能够更改该网站内容的人，都可以读取您在这里输入的密码，而您无从察觉。加密本身无法阻止这一点：这是在浏览器中打开保险柜的代价。",
    trust_app: "<b>Windows 版本无法被远程更改</b>，对您看重的保险柜来说是更安全的选择。它能完成本页面的全部功能，还可以连接您的手机。了解这一点之后，您也可以继续在这里使用。",
    trust_app_btn: "Windows 版本",
    trust_go_on: "继续",
